...
Additional ways to set and control the document. Very important. 

```{r setup, include=FALSE}
knitr::opts_chunk$set(
  # echo: Toggles whether or not to show the output Code Chunk is always run 
    echo = TRUE,
    eval = TRUE,
    message = FALSE,
    warning = FALSE,
...
Options for theme - can be found on Bootswatch
...
> PROTIPS: TABSETS ARE GREAT FOR BUILDING INTERACTIVE REPORT WITH MULTIPLE PLOTS WE WILL DO THIS IN A SALES REPORT
