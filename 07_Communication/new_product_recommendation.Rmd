...
> ProTips: Rmd files are self-contained. Knitting requires all libraries, functions, data, and other dependencies to be loaded or created using R Chunks in the document. This is why source() functions that are not built inside the document. 

```{r}
setwd("/Users/seunghyunsung/Documents/Business_Science/Business_101/")
source("01_Scripts/separate_bikes_and_outlier_detection.R")
source("01_Scripts/plot_product_recommendation.R")
```
